...
## Data API
- Read: GET /app/projectmanagment/api/<file>
- Write: PUT /app/projectmanagment/api/<file>
...
- Fallback: localStorage (key: pulseos-app-projectmanagment)
...
- Dateiname: projectmanagment-backup-YYYY-MM-DD.json
